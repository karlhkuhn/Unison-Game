...
class World1Level1: SKScene, SKPhysicsContactDelegate {
	...
	override func didMoveToView(view: SKView) {
		...
		let t1Swipes = defaults.integerForKey("Tutorial1")
		let t2Swipes = defaults.integerForKey("Tutorial2")
		let t3Swipes = defaults.integerForKey("Tutorial3")
		print("Tut 1 Swipes = \(t1Swipes)")
		print("Tut 2 Swipes = \(t2Swipes)")
		print("Tut 3 Swipes = \(t3Swipes)")
...
//				matrixGridLeftReferencePoints["C4"]!
//			])
//		playingBoardNode.addChild(wall1)
//		
//		
//		let wall2 = WallPath(wallBounceType: .Wall, wallPoints:
//			[
//				matrixGridLeftReferencePoints["D2"]!,
//				matrixGridLeftReferencePoints["D5"]!
//			])
...
//		verticalWall2.position = CGPoint(x: matrixGridColumnAllyLeft["3,2"]!.x, y: playableRect.size.height / 2) + CGPoint(x: 0, y: tileSide - 5)
	...
	func advanceToNextLevel() {
		...
		let scene = World1Level2(size: gameSize)
	...
	func didRestartLevel() {
		let scene = World1Level1(size: gameSize)
	...
	func didBeginContact(contact: SKPhysicsContact) {
		...
		if collision == PhysicsCategory.MirrorPlayer | PhysicsCategory.Goal {
			if playerHitGoal == true {
				...
				let defaults = NSUserDefaults.standardUserDefaults()
				defaults.setInteger(swipesMade, forKey: "Swipes-World1Level1")
