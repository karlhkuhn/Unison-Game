...
class World1Level2: SKScene, SKPhysicsContactDelegate {
	...
	var playerGridStartPosition: String
	...
	override init (size: CGSize) {
		...
		currentLevelTitle = "World 1 - Level 2"
		numberOfRowsInGrid = 4
		numberOfTilesPerRow = 4
		playerGridStartPosition = "I2"
	...
	func setupPlayers() {
		...
		player.position = matrixGridLeft[playerGridStartPosition]!
	...
	func setUpObstacles() {
		...
		let wall1 = WallPath(wallBounceType: .WallDeivation, wallPoints:
			[
				matrixGridLeftReferencePoints["B2"]!,
		...
		let wall3 = WallPath(wallBounceType: .WallDeivation, wallPoints:
			[
				matrixGridLeftReferencePoints["B3"]!,
	...
	func didBeginContact(contact: SKPhysicsContact) {
		...
		if collision == PhysicsCategory.MirrorPlayer | PhysicsCategory.Goal {
			if playerHitGoal == true {
				...
				defaults.setInteger(swipesMade, forKey: "Swipes-World1Level2")
